# Generated by Django 6.0.4 on 2026-05-08 14:01
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        default=1,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="student_management_app.division",
                    ),
                ),
                (
                    "session_year_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ct1_marks", models.FloatField(default=0)),
                ("ct2_marks", models.FloatField(default=0)),
                ("midsem_marks", models.FloatField(default=0)),
                ("endsem_marks", models.FloatField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("lectures_taken", models.IntegerField(default=0)),
                ("syllabus_percentage", models.FloatField(default=0)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "staff_id",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                default=1,
                on_delete=django.db.models.deletion.CASCADE,
                to="student_management_app.year",
            ),
        ),
        migrations.AddField(
            model_name="students",
